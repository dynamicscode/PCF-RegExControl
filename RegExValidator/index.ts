...
export class RegExValidator implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public refreshData(evt: Event) : void
	{
		...
		this.validate(this._value, this._regex);
		...
		container:HTMLDivElement)
	{
		...
		this._regex = context.parameters.regExValue.raw;
	...
	private validate(value:string, regex: string): void {
		var re = new RegExp(regex);
		var css = re.test(value) ? "" : "warning";
		this.inputElement.setAttribute("class", css);
	}
}